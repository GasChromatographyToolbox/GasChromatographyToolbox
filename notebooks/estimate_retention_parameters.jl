...
#=	import Pkg
	...
	md"""
	online, estimate\_retention\_parameters, for RetentionParameterEstimator v$(version)
	"""
=#
...
Estimation of Distribution-centric retention parameters from temperature programmed GC runs with different temperature programs.
"""

# ╔═╡ 8f6a85b9-a873-44ec-b99f-a4c3fb743f11
md"""
# Settings
"""
...
begin
	if !isnothing(file_meas)
		md"""
		Select measurements:
		$(@bind selected_measurements confirm(MultiSelect(meas[3].measurement; default=meas[3].measurement[1:5])))
...
# ╔═╡ 5a9f189c-6ce4-4d0b-9909-6450419ca3fc
md"""
...
[compat]
RetentionParameterEstimator = "~0.1.10"
"""
...
manifest_format = "2.0"
project_hash = "05190a55a6a561750bee14bcce9f4a7db4789d19"
...
[[deps.ForwardDiffOverMeasurements]]
deps = ["ForwardDiff", "Measurements"]
git-tree-sha1 = "da838bdda7fd88c37a2eb40391a6553a442c1d01"
...
deps = ["CSV", "ChemicalIdentifiers", "DataFrames", "ForwardDiff", "ForwardDiffOverMeasurements", "HypertextLiteral", "Integrals", "Interpolations", "Measurements", "OrdinaryDiffEq", "Plots", "PlutoUI", "Reexport", "UrlDownload"]
git-tree-sha1 = "65f6ab0bf20a0eb9b092fbc06b2796156effb8cc"
...
git-tree-sha1 = "347e7cd1a67fd38be1083c4164be1404fc1dbd49"
...
git-tree-sha1 = "406bb881a8d4ac57347dc2b50294b059db2750e6"
